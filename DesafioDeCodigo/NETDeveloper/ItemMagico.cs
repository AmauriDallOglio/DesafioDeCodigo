namespace DesafioDeCodigo.NETDeveloper
{
    public class ItemMagico
    {
        public void Executar()
        {
            ...
            Console.WriteLine($"Digite descricao: ");
            string descricao = Console.ReadLine();

            Console.WriteLine($"Digite poder: ");
            int poder = int.Parse(Console.ReadLine());

            // Cria o item mágico
            ItemMagicoObj item = new ItemMagicoObj(nome, descricao, poder);
        ...
        public class ItemMagicoObj
        {
            ...
            public ItemMagicoObj(string nome, string descricao, int poder)
            {
                Nome = nome;
                Descricao = descricao;
                Poder = poder;
